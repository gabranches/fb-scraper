...
url = "https://graph.facebook.com/%s/posts?access_token=CAACEdEose0cBAE7HoJyN3YbQRjWGOA4ojFjexiVIWaPPGc0LV7BFf95lQ7J5GiZAH0w6q6AVr1K17MVjgJI3QYMg0ik5VMl0rqEyrTRxMRp1sLJkTNFAPmgxi6cafHflwr1ZAlI5JwXJKY28zsLJ7KsGnfN7HOEOMXmHndlpDzHXzsZANoUTtkoCGy4ZCZAu9SLGJTeA8dj3lZCrZC2EDYN&include_hidden=true" #paste your own access token here.
...
class Scrape:
    def __init__(self):   
        engine = sqlalchemy.create_engine("sqlite:///Macintosh HD/Users/jiyigrace/Desktop/Data mining/facebookmining.sqlite", echo=False) #enter your database name here and its file path. 
    ...
    def main(self):
        ...
        keys = []
        ids = ['rmhcsouthflorida'] #if a page name contains multiple words, separated by space (e.g. SPOT Coffee); it will show up as words connected by hyphens in URL. For example, SPOT Cofee as in "Spot-Coffee-Elmwood." If so, it is recommended that you use page id. You can find page id in the URL - it is the string of numbers after page name in URL.  (e.g. https://www.facebook.com/pages/Spot-Coffee-Elmwood/316579834919)
        for feed in ids:
            kid = feed 
            d = get_data(kid)

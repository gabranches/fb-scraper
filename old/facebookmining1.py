...
url = "https://graph.facebook.com/%s/posts?access_token=CAACEdEose0cBAEFilqlQWhoWCuJ9oygICRgvyQP5mMc6jLjpc1D10qwaT5YQBLleeUBJvIFOe08RfwJdOsYsNKn78oGOcpc1WALwIaJO5LqwJAkviHT7apBlGKys32a5j9g1VDBaR8LQQyCa3hyzokFpVJ4CILkZB5LFZAXACPLb6NPZAIG2Dk0j96ktAVecfxDjpABGzzxQrSYVusi&include_hidden=true" #paste your own access token here.
...
class Scrape:
    def __init__(self):   
        engine = sqlalchemy.create_engine("sqlite:///unitedway.sqlite", echo=False) #enter your database name here and its file path. 
